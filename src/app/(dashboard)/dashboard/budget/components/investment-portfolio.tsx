      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card>
          ...
          <CardContent>
            ...
            <div className="text-sm text-green-600 mt-1">+8.7% overall return</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
          ...
          <CardContent>
            ...
            <div className="text-sm text-gray-500 mt-1">Next contribution: Apr 15</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
          ...
          <CardContent>
            ...
            <div className="text-sm text-gray-500 mt-1">Medium risk tolerance</div>
          </CardContent>
        </Card>
      </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="rounded-md border">
                <div className="grid grid-cols-6 bg-slate-50 p-4 font-medium">
                  ...
                  {investments.map((investment, i) => (
                    <div key={i} className="grid grid-cols-6 p-4 items-center">
                      <div className="col-span-2">
                        ...
                        <div className="text-sm text-gray-500">Risk: {investment.risk}</div>
                      </div>
              ...
              <div className="space-y-4 mt-4">
                {recommendations.map((rec, i) => (
                  <div key={i} className="flex items-start p-4 bg-slate-50 rounded-lg">
                    <ArrowUpRight className="h-5 w-5 mr-2 text-green-600 mt-0.5" />
                    <div>{rec}</div>
                  </div>
                ))}
              </div>
                  ...
                  <div className="p-4 border rounded-lg">
                    <div className="flex justify-between">
                      <div>
                        ...
                        <div className="text-sm text-gray-500">Broad market exposure with low fees</div>
                      </div>
                  ...
                  <div className="p-4 border rounded-lg">
                    <div className="flex justify-between">
                      <div>
                        ...
                        <div className="text-sm text-gray-500">Geographical diversification</div>
                      </div>
                      <Badge>Recommended</Badge>
                    </div>
                  </div>
                  <div className="p-4 border rounded-lg">
                    <div className="flex justify-between">
                      <div>
                        ...
                        <div className="text-sm text-gray-500">Lower risk fixed income</div>
                      </div>
