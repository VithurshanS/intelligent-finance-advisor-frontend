    ...
    <div className="space-y-6 p-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="bg-gray-800 border-gray-700">
          ...
          <CardContent>
            ...
            <div className="text-sm text-gray-300 mt-1">${typeof largestAmount === 'number' ? largestAmount.toFixed(2) : 0}</div>
          </CardContent>
        </Card>
      </div>
      ...
      <Tabs defaultValue="all">
        <TabsList className="mb-4 bg-gray-700 p-1 rounded-lg">
          <TabsTrigger value="all" className="text-gray-200 data-[state=active]:bg-blue-600 data-[state=active]:text-white">
            All Transactions
          </TabsTrigger>
          <TabsTrigger value="expenses" className="text-gray-200 data-[state=active]:bg-blue-600 data-[state=active]:text-white">
            Expense List
          </TabsTrigger>
          <TabsTrigger value="income" className="text-gray-200 data-[state=active]:bg-blue-600 data-[state=active]:text-white">
            Income List
          </TabsTrigger>
        ...
        <TabsContent value="all">
          <div className="grid gap-4">
            {currentTransactions.all.map(txn => (
              <Card key={txn.id} className="bg-gray-800 border-gray-700 hover:border-gray-600 transition-colors duration-200">
                <CardHeader className="pb-3">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="text-right">
                      <span className={`text-xl font-bold ${txn.type === 'expense' ? 'text-red-400' : 'text-green-400'}`}>
                        {txn.type === 'expense' ? '-' : '+'}
          ...
          <form onSubmit={handleAddTransaction} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input type="number" min="0" step="0.01" value={newTransaction.amount} onChange={e => setNewTransaction({ ...newTransaction, amount: parseFloat(e.target.value) })} />
              </div>
              {/* <div>
              ...
              <div>
                ...
                <Input value={newTransaction.reason} onChange={e => setNewTransaction({ ...newTransaction, reason: e.target.value })} />
              </div>
              <div>
                <Label className="text-white">Type</Label>
                <Select
                  value={newTransaction.type}
                  onValueChange={(value) => setNewTransaction({ ...newTransaction, type: value.toLowerCase() })}
                >
                  <SelectTrigger>
