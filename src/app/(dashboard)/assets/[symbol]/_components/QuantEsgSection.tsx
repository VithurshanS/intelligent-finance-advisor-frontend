    ...
    const getRiskColor = (value: number | null | undefined, reverse: boolean = false) => {
        ...
        if (reverse) {
            return value > threshold.low ? 'bg-green-500' :
                value > threshold.medium ? 'bg-yellow-500' : 'bg-red-500';
        } else {
            return value < threshold.low ? 'bg-green-500' :
                value < threshold.medium ? 'bg-yellow-500' : 'bg-red-500';
        }
                        ...
                        <CardHeader className="pb-2">
                            <div className="flex justify-between items-center">
                                ...
                                {quantRisk.risk_metrics?.quant_risk_score !== undefined && (
                                    <Badge className={getRiskColor(quantRisk.risk_metrics.quant_risk_score)}>
                                        Score: {quantRisk.risk_metrics.quant_risk_score.toFixed(1)}/10
                                    </Badge>
                                )}
                            </div>
                            <CardDescription>
                        ...
                        <CardHeader className="pb-2">
                            <div className="flex justify-between items-center">
                                ...
                                {esgRisk.esg_risk_score !== undefined && esgRisk.esg_risk_score !== null && (
                                    <Badge className={getRiskColor(esgRisk.esg_risk_score)}>
                                        Risk: {esgRisk.esg_risk_score.toFixed(1)}/10
                                    </Badge>
                                )}
                            </div>
                            <CardDescription>
                      ...
                      {esgRisk.total_esg !== undefined && esgRisk.total_esg !== null
                          ...
                          : 'N/A'}
                                    ...
                                    <Progress
                                        ...
                                        className={getRiskColor((esgRisk.total_esg / 3), true)}
                                    />
                                </div>
                      ...
                      {esgRisk.environmental_score !== undefined && esgRisk.environmental_score !== null
                          ...
                          : 'N/A'}
                                    ...
                                    <Progress
                                        ...
                                        className={getRiskColor(esgRisk.environmental_score, true)}
                                    />
                                </div>
                      ...
                      {esgRisk.social_score !== undefined && esgRisk.social_score !== null
                          ...
                          : 'N/A'}
                                    ...
                                    <Progress
                                        ...
                                        className={getRiskColor(esgRisk.social_score, true)}
                                    />
                                </div>
                      ...
                      {esgRisk.governance_score !== undefined && esgRisk.governance_score !== null
                          ...
                          : 'N/A'}
                                    ...
                                    <Progress
                                        ...
                                        className={getRiskColor(esgRisk.governance_score, true)}
                                    />
                                </div>
                            </div>
                        </CardContent>
